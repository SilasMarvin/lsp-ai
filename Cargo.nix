...
args@{
  ...
  rootFeatures ? [
    "lsp-ai/default"
    "splitter-tree-sitter/default"
    "utils-tree-sitter/default"
    "xtask/default"
  ],
  rustPackages,
  buildRustPackages,
...
let
  nixifiedLockHash = "612fdd9db4c86cb9c10ef4b9b2ec932f8ddea18b6ee730399c797aa218c27d01";
...
in if !lockHashIgnored && (nixifiedLockHash != currentLockHash) then
  ...
  profilesByName = {
    dev = builtins.fromTOML "[package.miniz_oxide]\nopt-level = 3\n";
...
in
{
  ...
  workspace = {
    lsp-ai = rustPackages.unknown.lsp-ai."0.5.1";
    splitter-tree-sitter = rustPackages.unknown.splitter-tree-sitter."0.1.0";
    utils-tree-sitter = rustPackages.unknown.utils-tree-sitter."0.1.0";
  ...
  "registry+https://github.com/rust-lang/crates.io-index".assert_cmd."2.0.16" = overridableMkRustCrate (profileName: rec {
    name = "assert_cmd";
    version = "2.0.16";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "dc1835b7f27878de8525dc71410b5a31cdcc5f230aed5ba5df968e09c201b23d"; };
    dependencies = {
      anstyle = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".anstyle."1.0.8" { inherit profileName; }).out;
      ...
      ${ if false then "libc" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.155" { inherit profileName; }).out;
      predicates = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".predicates."3.1.2" { inherit profileName; }).out;
      predicates_core = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".predicates-core."1.0.8" { inherit profileName; }).out;
      predicates_tree = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".predicates-tree."1.0.11" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".auto_enums."0.8.5" = overridableMkRustCrate (profileName: rec {
    name = "auto_enums";
    version = "0.8.5";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "1899bfcfd9340ceea3533ea157360ba8fa864354eccbceab58e1006ecab35393"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "std" ]
    ];
    dependencies = {
      derive_utils = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".derive_utils."0.14.1" { inherit profileName; }).out;
      proc_macro2 = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".proc-macro2."1.0.86" { inherit profileName; }).out;
      quote = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".quote."1.0.36" { inherit profileName; }).out;
      syn = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".syn."2.0.74" { inherit profileName; }).out;
    };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".bindgen."0.69.4" = overridableMkRustCrate (profileName: rec {
    ...
    features = builtins.concatLists [
      (lib.optional (rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal") "default")
      (lib.optional (rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal") "logging")
      (lib.optional (rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal") "prettyplease")
      (lib.optional (rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal") "runtime")
      (lib.optional (rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal") "which-rustfmt")
    ];
    dependencies = {
      ${ if rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal" then "bitflags" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".bitflags."2.6.0" { inherit profileName; }).out;
      ${ if rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal" then "cexpr" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".cexpr."0.6.0" { inherit profileName; }).out;
      ${ if rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal" then "clang_sys" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".clang-sys."1.8.1" { inherit profileName; }).out;
      ${ if rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal" then "itertools" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".itertools."0.12.1" { inherit profileName; }).out;
      ${ if rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal" then "lazy_static" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".lazy_static."1.5.0" { inherit profileName; }).out;
      ${ if rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal" then "lazycell" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".lazycell."1.3.0" { inherit profileName; }).out;
      ${ if rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal" then "log" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.22" { inherit profileName; }).out;
      ${ if rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal" then "prettyplease" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".prettyplease."0.2.20" { inherit profileName; }).out;
      ${ if rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal" then "proc_macro2" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".proc-macro2."1.0.86" { inherit profileName; }).out;
      ${ if rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal" then "quote" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".quote."1.0.36" { inherit profileName; }).out;
      ${ if rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal" then "regex" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".regex."1.10.6" { inherit profileName; }).out;
      ${ if rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal" then "rustc_hash" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-hash."1.1.0" { inherit profileName; }).out;
      ${ if rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal" then "shlex" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".shlex."1.3.0" { inherit profileName; }).out;
      ${ if rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal" then "syn" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".syn."2.0.74" { inherit profileName; }).out;
      ${ if rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal" then "which" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".which."4.4.2" { inherit profileName; }).out;
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".cc."1.0.106" = overridableMkRustCrate (profileName: rec {
    ...
    features = builtins.concatLists [
      (lib.optional (rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal") "parallel")
    ];
    dependencies = {
      ${ if rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal" then "jobserver" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".jobserver."0.1.32" { inherit profileName; }).out;
      ${ if (rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal") && hostPlatform.isUnix then "libc" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.155" { inherit profileName; }).out;
      ${ if rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal" then "once_cell" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".once_cell."1.19.0" { inherit profileName; }).out;
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".cexpr."0.6.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal" then "nom" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".nom."7.1.3" { inherit profileName; }).out;
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".clang-sys."1.8.1" = overridableMkRustCrate (profileName: rec {
    ...
    features = builtins.concatLists [
      (lib.optional (rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal") "clang_3_5")
      (lib.optional (rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal") "clang_3_6")
      (lib.optional (rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal") "clang_3_7")
      (lib.optional (rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal") "clang_3_8")
      (lib.optional (rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal") "clang_3_9")
      (lib.optional (rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal") "clang_4_0")
      (lib.optional (rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal") "clang_5_0")
      (lib.optional (rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal") "clang_6_0")
      (lib.optional (rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal") "libloading")
      (lib.optional (rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal") "runtime")
    ];
    dependencies = {
      ${ if rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal" then "glob" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".glob."0.3.1" { inherit profileName; }).out;
      ${ if rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal" then "libc" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.155" { inherit profileName; }).out;
      ${ if rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal" then "libloading" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".libloading."0.8.5" { inherit profileName; }).out;
    };
    buildDependencies = {
      ${ if rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal" then "glob" else null } = (buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".glob."0.3.1" { profileName = "__noProfile"; }).out;
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".ctrlc."3.4.5" = overridableMkRustCrate (profileName: rec {
    name = "ctrlc";
    version = "3.4.5";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "90eeab0aa92f3f9b4e87f258c72b139c207d251f9cbc1080a0086b86a8870dd3"; };
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".derive_utils."0.14.1" = overridableMkRustCrate (profileName: rec {
    name = "derive_utils";
    version = "0.14.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "61bb5a1014ce6dfc2a378578509abe775a5aa06bff584a547555d9efdb81b926"; };
    dependencies = {
      proc_macro2 = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".proc-macro2."1.0.86" { inherit profileName; }).out;
      quote = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".quote."1.0.36" { inherit profileName; }).out;
      syn = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".syn."2.0.74" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".enumflags2."0.7.10" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal" then "enumflags2_derive" else null } = (buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".enumflags2_derive."0.7.10" { profileName = "__noProfile"; }).out;
    };
  });
  ...
  "git+https://github.com/huggingface/hf-hub".hf-hub."0.3.2" = overridableMkRustCrate (profileName: rec {
    name = "hf-hub";
    version = "0.3.2";
    registry = "git+https://github.com/huggingface/hf-hub";
    src = fetchCrateGit {
      url = https://github.com/huggingface/hf-hub;
      name = "hf-hub";
      version = "0.3.2";
      rev = "9d6502f5bc2e69061c132f523c76a76dad470477";};
    features = builtins.concatLists [
      [ "default" ]
      [ "default-tls" ]
      [ "tokio" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".indexmap."2.4.0" = overridableMkRustCrate (profileName: rec {
    ...
    features = builtins.concatLists [
      [ "default" ]
      (lib.optional (rootFeatures' ? "lsp-ai/default" || rootFeatures' ? "lsp-ai/rayon") "rayon")
      [ "serde" ]
      [ "std" ]
    ];
    dependencies = {
      ...
      hashbrown = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".hashbrown."0.14.5" { inherit profileName; }).out;
      ${ if rootFeatures' ? "lsp-ai/default" || rootFeatures' ? "lsp-ai/rayon" then "rayon" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".rayon."1.10.0" { inherit profileName; }).out;
      serde = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.207" { inherit profileName; }).out;
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".itertools."0.12.1" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal" then "either" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".either."1.13.0" { inherit profileName; }).out;
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".libloading."0.8.5" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if (rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal") && hostPlatform.isUnix then "cfg_if" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".cfg-if."1.0.0" { inherit profileName; }).out;
      ${ if (rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal") && hostPlatform.isWindows then "windows_targets" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".windows-targets."0.52.6" { inherit profileName; }).out;
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".llama-cpp-2."0.1.64" = overridableMkRustCrate (profileName: rec {
    name = "llama-cpp-2";
    version = "0.1.64";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "7d06b23f7c63e64ffceb0fab92746393dfbb76de41e02fd6751aeafff6a921e9"; };
    features = builtins.concatLists [
      (lib.optional (rootFeatures' ? "lsp-ai/cuda") "cuda")
      (lib.optional (rootFeatures' ? "lsp-ai/metal") "metal")
    ];
    dependencies = {
      ${ if rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal" then "enumflags2" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".enumflags2."0.7.10" { inherit profileName; }).out;
      ${ if rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal" then "llama_cpp_sys_2" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".llama-cpp-sys-2."0.1.64" { inherit profileName; }).out;
      ${ if rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal" then "thiserror" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".thiserror."1.0.63" { inherit profileName; }).out;
      ${ if rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal" then "tracing" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.40" { inherit profileName; }).out;
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".llama-cpp-sys-2."0.1.64" = overridableMkRustCrate (profileName: rec {
    name = "llama-cpp-sys-2";
    version = "0.1.64";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "429e10ceb3c385e9094d0adb75ae976d433f53977281f598f6a7cbae8d265d50"; };
    features = builtins.concatLists [
      (lib.optional (rootFeatures' ? "lsp-ai/cuda") "cuda")
      (lib.optional (rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal") "metal")
    ];
    buildDependencies = {
      ${ if rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal" then "bindgen" else null } = (buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".bindgen."0.69.4" { profileName = "__noProfile"; }).out;
      ${ if rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal" then "cc" else null } = (buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".cc."1.0.106" { profileName = "__noProfile"; }).out;
      ${ if rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal" then "once_cell" else null } = (buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".once_cell."1.19.0" { profileName = "__noProfile"; }).out;
    };
  });
  ...
  "unknown".lsp-ai."0.5.1" = overridableMkRustCrate (profileName: rec {
    name = "lsp-ai";
    version = "0.5.1";
    registry = "unknown";
    ...
    features = builtins.concatLists [
      (lib.optional (rootFeatures' ? "lsp-ai/cuda") "cuda")
      (lib.optional (rootFeatures' ? "lsp-ai/default") "default")
      (lib.optional (rootFeatures' ? "lsp-ai/llama_cpp") "llama_cpp")
      (lib.optional (rootFeatures' ? "lsp-ai/metal") "metal")
      (lib.optional (rootFeatures' ? "lsp-ai/default" || rootFeatures' ? "lsp-ai/rayon") "rayon")
      (lib.optional (rootFeatures' ? "lsp-ai/default" || rootFeatures' ? "lsp-ai/simsimd") "simsimd")
      (lib.optional (rootFeatures' ? "lsp-ai/stress_test") "stress_test")
    ];
    dependencies = {
      ...
      hf_hub = (rustPackages."git+https://github.com/huggingface/hf-hub".hf-hub."0.3.2" { inherit profileName; }).out;
      ignore = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".ignore."0.4.22" { inherit profileName; }).out;
      indexmap = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".indexmap."2.4.0" { inherit profileName; }).out;
      ${ if rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal" then "llama_cpp_2" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".llama-cpp-2."0.1.64" { inherit profileName; }).out;
      lsp_server = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".lsp-server."0.7.6" { inherit profileName; }).out;
      lsp_types = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".lsp-types."0.95.1" { inherit profileName; }).out;
      md5 = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".md5."0.7.0" { inherit profileName; }).out;
      ...
      parking_lot = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".parking_lot."0.12.3" { inherit profileName; }).out;
      pgml = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".pgml."1.1.1" { inherit profileName; }).out;
      rand = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".rand."0.8.5" { inherit profileName; }).out;
      ${ if rootFeatures' ? "lsp-ai/default" || rootFeatures' ? "lsp-ai/rayon" then "rayon" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".rayon."1.10.0" { inherit profileName; }).out;
      ...
      serde = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.207" { inherit profileName; }).out;
      serde_json = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_json."1.0.125" { inherit profileName; }).out;
      ${ if rootFeatures' ? "lsp-ai/default" || rootFeatures' ? "lsp-ai/simsimd" then "simsimd" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".simsimd."4.4.0" { inherit profileName; }).out;
      splitter_tree_sitter = (rustPackages."unknown".splitter-tree-sitter."0.1.0" { inherit profileName; }).out;
      text_splitter = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".text-splitter."0.13.3" { inherit profileName; }).out;
      ...
      tree_sitter = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tree-sitter."0.22.6" { inherit profileName; }).out;
      utils_tree_sitter = (rustPackages."unknown".utils-tree-sitter."0.1.0" { inherit profileName; }).out;
      xxhash_rust = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".xxhash-rust."0.8.12" { inherit profileName; }).out;
    };
    devDependencies = {
      assert_cmd = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".assert_cmd."2.0.16" { inherit profileName; }).out;
    };
    buildDependencies = {
      cc = (buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".cc."1.0.106" { profileName = "__noProfile"; }).out;
    };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".lsp-types."0.95.1" = overridableMkRustCrate (profileName: rec {
    name = "lsp-types";
    version = "0.95.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "8e34d33a8e9b006cd3fc4fe69a921affa097bae4bb65f76271f4644f9a334365"; };
    features = builtins.concatLists [
      [ "default" ]
    ];
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".memo-map."0.3.3" = overridableMkRustCrate (profileName: rec {
    name = "memo-map";
    version = "0.3.3";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "38d1115007560874e373613744c6fba374c17688327a71c1476d1a5954cc857b"; };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".minijinja."1.0.21" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      memo_map = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".memo-map."0.3.3" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".native-tls."0.2.12" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${ if hostPlatform.parsed.kernel.name == "darwin" then "tempfile" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tempfile."3.12.0" { inherit profileName; }).out;
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".openssl-src."300.3.1+3.3.1" = overridableMkRustCrate (profileName: rec {
    name = "openssl-src";
    version = "300.3.1+3.3.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "7259953d42a81bf137fbbd73bd30a8e1914d6dce43c2b90ed575783a22608b91"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "legacy" ]
    ];
    dependencies = {
      cc = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".cc."1.0.106" { inherit profileName; }).out;
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".openssl-sys."0.9.103" = overridableMkRustCrate (profileName: rec {
    ...
    buildDependencies = {
      cc = (buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".cc."1.0.106" { profileName = "__noProfile"; }).out;
      openssl_src = (buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".openssl-src."300.3.1+3.3.1" { profileName = "__noProfile"; }).out;
      pkg_config = (buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".pkg-config."0.3.30" { profileName = "__noProfile"; }).out;
      vcpkg = (buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".vcpkg."0.2.15" { profileName = "__noProfile"; }).out;
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".pgml."1.1.1" = overridableMkRustCrate (profileName: rec {
    name = "pgml";
    version = "1.1.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "8be31e46bc76171d107c250a98e9c4f796704d5a9af3ae9d00d23060706e2112"; };
    features = builtins.concatLists [
      [ "default" ]
    ];
    dependencies = {
      ...
      ctrlc = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".ctrlc."3.4.5" { inherit profileName; }).out;
      futures = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures."0.3.30" { inherit profileName; }).out;
      indicatif = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".indicatif."0.17.8" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".predicates."3.1.2" = overridableMkRustCrate (profileName: rec {
    name = "predicates";
    version = "3.1.2";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "7e9086cc7640c29a356d1a29fd134380bee9d8f79a17410aa76e7ad295f42c97"; };
    features = builtins.concatLists [
      [ "diff" ]
    ];
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".predicates-core."1.0.8" = overridableMkRustCrate (profileName: rec {
    name = "predicates-core";
    version = "1.0.8";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "ae8177bee8e75d6846599c6b9ff679ed51e882816914eec639944d7c9aa11931"; };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".predicates-tree."1.0.11" = overridableMkRustCrate (profileName: rec {
    name = "predicates-tree";
    version = "1.0.11";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "41b740d195ed3166cd147c8047ec98db0e22ec019eb8eeb76d343b795304fb13"; };
    dependencies = {
      predicates_core = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".predicates-core."1.0.8" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".prettyplease."0.2.20" = overridableMkRustCrate (profileName: rec {
    ...
    features = builtins.concatLists [
      (lib.optional (rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal") "verbatim")
    ];
    dependencies = {
      ${ if rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal" then "proc_macro2" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".proc-macro2."1.0.86" { inherit profileName; }).out;
      ${ if rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal" then "syn" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".syn."2.0.74" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".reqwest."0.12.5" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${ if !(hostPlatform.parsed.cpu.name == "wasm32") then "hyper_util" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".hyper-util."0.1.7" { inherit profileName; }).out;
      ${ if !(hostPlatform.parsed.cpu.name == "wasm32") then "ipnet" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".ipnet."2.9.0" { inherit profileName; }).out;
      ${ if hostPlatform.parsed.cpu.name == "wasm32" then "js_sys" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".js-sys."0.3.70" { inherit profileName; }).out;
      ${ if !(hostPlatform.parsed.cpu.name == "wasm32") then "log" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.22" { inherit profileName; }).out;
      ${ if !(hostPlatform.parsed.cpu.name == "wasm32") then "mime" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".mime."0.3.17" { inherit profileName; }).out;
      ...
      ${ if !(hostPlatform.parsed.cpu.name == "wasm32") then "percent_encoding" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".percent-encoding."2.3.1" { inherit profileName; }).out;
      ${ if !(hostPlatform.parsed.cpu.name == "wasm32") then "pin_project_lite" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".pin-project-lite."0.2.14" { inherit profileName; }).out;
      ${ if !(hostPlatform.parsed.cpu.name == "wasm32") then "rustls_pemfile" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustls-pemfile."2.1.3" { inherit profileName; }).out;
      serde = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.207" { inherit profileName; }).out;
      serde_json = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_json."1.0.125" { inherit profileName; }).out;
      serde_urlencoded = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_urlencoded."0.7.1" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".ropey."1.6.1" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      smallvec = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".smallvec."1.13.2" { inherit profileName; }).out;
      str_indices = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".str_indices."0.4.3" { inherit profileName; }).out;
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-hash."1.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    features = builtins.concatLists [
      (lib.optional (rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal") "default")
      (lib.optional (rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal") "std")
    ];
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".sea-query."0.30.7" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      sea_query_attr = (buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".sea-query-attr."0.1.2" { profileName = "__noProfile"; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".sea-query-attr."0.1.2" = overridableMkRustCrate (profileName: rec {
    name = "sea-query-attr";
    version = "0.1.2";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "168a31e0ef5a791ad26aa97c502eaed8d2a1ffdc22b3249f9947c1e12be6b477"; };
    dependencies = {
      darling = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".darling."0.14.4" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".serde_with."3.9.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      indexmap_2 = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".indexmap."2.4.0" { inherit profileName; }).out;
      serde = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.207" { inherit profileName; }).out;
      serde_derive = (buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_derive."1.0.207" { profileName = "__noProfile"; }).out;
      serde_json = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_json."1.0.125" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".simsimd."4.4.0" = overridableMkRustCrate (profileName: rec {
    name = "simsimd";
    version = "4.4.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "efc843bc8f12d9c8e6b734a0fe8918fc497b42f6ae0f347dbfdad5b5138ab9b4"; };
    buildDependencies = {
      ${ if rootFeatures' ? "lsp-ai/default" || rootFeatures' ? "lsp-ai/simsimd" then "cc" else null } = (buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".cc."1.0.106" { profileName = "__noProfile"; }).out;
    };
  });
  ...
  "unknown".splitter-tree-sitter."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    devDependencies = {
      tree_sitter_rust = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tree-sitter-rust."0.21.2" { inherit profileName; }).out;
      tree_sitter_zig = (rustPackages."git+https://github.com/maxxnino/tree-sitter-zig".tree-sitter-zig."0.0.1" { inherit profileName; }).out;
    };
    buildDependencies = {
      cc = (buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".cc."1.0.106" { profileName = "__noProfile"; }).out;
    };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".str_indices."0.4.3" = overridableMkRustCrate (profileName: rec {
    name = "str_indices";
    version = "0.4.3";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "e9557cb6521e8d009c51a8666f09356f4b817ba9ba0981a305bd86aee47bd35c"; };
    features = builtins.concatLists [
      [ "simd" ]
    ];
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".text-splitter."0.13.3" = overridableMkRustCrate (profileName: rec {
    name = "text-splitter";
    version = "0.13.3";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "2ab9dc04b7cf08eb01c07c272bf699fa55679a326ddf7dd075e14094efc80fb9"; };
    dependencies = {
      ahash = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".ahash."0.8.11" { inherit profileName; }).out;
      auto_enums = (buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".auto_enums."0.8.5" { profileName = "__noProfile"; }).out;
      either = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".either."1.13.0" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tree-sitter."0.22.6" = overridableMkRustCrate (profileName: rec {
    name = "tree-sitter";
    version = "0.22.6";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "df7cc499ceadd4dcdf7ec6d4cbc34ece92c3fa07821e287aedecd4416c516dca"; };
    dependencies = {
      regex = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".regex."1.10.6" { inherit profileName; }).out;
    };
    buildDependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tree-sitter-bash."0.21.0" = overridableMkRustCrate (profileName: rec {
    name = "tree-sitter-bash";
    version = "0.21.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "b5244703ad2e08a616d859a0557d7aa290adcd5e0990188a692e628ffe9dce40"; };
    dependencies = {
      tree_sitter = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tree-sitter."0.22.6" { inherit profileName; }).out;
    };
    buildDependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tree-sitter-c."0.21.4" = overridableMkRustCrate (profileName: rec {
    name = "tree-sitter-c";
    version = "0.21.4";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "f956d5351d62652864a4ff3ae861747e7a1940dc96c9998ae400ac0d3ce30427"; };
    dependencies = {
      tree_sitter = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tree-sitter."0.22.6" { inherit profileName; }).out;
    };
    buildDependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tree-sitter-c-sharp."0.21.3" = overridableMkRustCrate (profileName: rec {
    name = "tree-sitter-c-sharp";
    version = "0.21.3";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "8997ad04502208449025114e434c9024a33a74e700513c702a9d2cac6522a771"; };
    dependencies = {
      tree_sitter = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tree-sitter."0.22.6" { inherit profileName; }).out;
    };
    buildDependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tree-sitter-cpp."0.22.3" = overridableMkRustCrate (profileName: rec {
    name = "tree-sitter-cpp";
    version = "0.22.3";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "1d509a22a992790d38f2c291961ff8a1ff016c437c7ec6befc9220b8eec8918c"; };
    dependencies = {
      tree_sitter = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tree-sitter."0.22.6" { inherit profileName; }).out;
    };
    buildDependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tree-sitter-css."0.21.0" = overridableMkRustCrate (profileName: rec {
    name = "tree-sitter-css";
    version = "0.21.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "e2f806f96136762b0121f5fdd7172a3dcd8f42d37a2f23ed7f11b35895e20eb4"; };
    dependencies = {
      tree_sitter = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tree-sitter."0.22.6" { inherit profileName; }).out;
    };
    buildDependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tree-sitter-elixir."0.2.0" = overridableMkRustCrate (profileName: rec {
    name = "tree-sitter-elixir";
    version = "0.2.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "df94bf7f057768b1cab2ee1f14812ed4ae33f9e04d09254043eeaa797db4ef70"; };
    dependencies = {
      tree_sitter = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tree-sitter."0.22.6" { inherit profileName; }).out;
    };
    buildDependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tree-sitter-erlang."0.6.0" = overridableMkRustCrate (profileName: rec {
    name = "tree-sitter-erlang";
    version = "0.6.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "8db61152e6d8a5b3b5895ecbb85848f85d028f84b4633a2368075c35e5817b34"; };
    dependencies = {
      tree_sitter = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tree-sitter."0.22.6" { inherit profileName; }).out;
    };
    buildDependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tree-sitter-go."0.21.0" = overridableMkRustCrate (profileName: rec {
    name = "tree-sitter-go";
    version = "0.21.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "55cb318be5ccf75f44e054acf6898a5c95d59b53443eed578e16be0cd7ec037f"; };
    dependencies = {
      tree_sitter = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tree-sitter."0.22.6" { inherit profileName; }).out;
    };
    buildDependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tree-sitter-haskell."0.21.0" = overridableMkRustCrate (profileName: rec {
    name = "tree-sitter-haskell";
    version = "0.21.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "ef25a7e6c73cc1cbe0c0b7dbd5406e7b3485b370bd61c5d8d852ae0781f9bf9a"; };
    dependencies = {
      tree_sitter = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tree-sitter."0.22.6" { inherit profileName; }).out;
    };
    buildDependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tree-sitter-html."0.20.3" = overridableMkRustCrate (profileName: rec {
    name = "tree-sitter-html";
    version = "0.20.3";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "95b3492b08a786bf5cc79feb0ef2ff3b115d5174364e0ddfd7860e0b9b088b53"; };
    dependencies = {
      tree_sitter = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tree-sitter."0.22.6" { inherit profileName; }).out;
    };
    buildDependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tree-sitter-java."0.21.0" = overridableMkRustCrate (profileName: rec {
    name = "tree-sitter-java";
    version = "0.21.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "33bc21adf831a773c075d9d00107ab43965e6a6ea7607b47fd9ec6f3db4b481b"; };
    dependencies = {
      tree_sitter = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tree-sitter."0.22.6" { inherit profileName; }).out;
    };
    buildDependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tree-sitter-javascript."0.21.4" = overridableMkRustCrate (profileName: rec {
    name = "tree-sitter-javascript";
    version = "0.21.4";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "8710a71bc6779e33811a8067bdda3ed08bed1733296ff915e44faf60f8c533d7"; };
    dependencies = {
      tree_sitter = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tree-sitter."0.22.6" { inherit profileName; }).out;
    };
    buildDependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tree-sitter-json."0.21.0" = overridableMkRustCrate (profileName: rec {
    name = "tree-sitter-json";
    version = "0.21.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "5b737dcb73c35d74b7d64a5f3dde158113c86a012bf3cee2bfdf2150d23b05db"; };
    dependencies = {
      tree_sitter = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tree-sitter."0.22.6" { inherit profileName; }).out;
    };
    buildDependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tree-sitter-lua."0.1.0" = overridableMkRustCrate (profileName: rec {
    name = "tree-sitter-lua";
    version = "0.1.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "3b9fe6fc87bd480e1943fc1fcb02453fb2da050e4e8ce0daa67d801544046856"; };
    dependencies = {
      tree_sitter = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tree-sitter."0.22.6" { inherit profileName; }).out;
    };
    buildDependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tree-sitter-ocaml."0.22.0" = overridableMkRustCrate (profileName: rec {
    name = "tree-sitter-ocaml";
    version = "0.22.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "e2f2e8e848902d12ca6778d31d0e66b5709fc1ad0c84fd8b0c078472fff20dd2"; };
    dependencies = {
      tree_sitter = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tree-sitter."0.22.6" { inherit profileName; }).out;
    };
    buildDependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tree-sitter-python."0.21.0" = overridableMkRustCrate (profileName: rec {
    name = "tree-sitter-python";
    version = "0.21.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "b4066c6cf678f962f8c2c4561f205945c84834cce73d981e71392624fdc390a9"; };
    dependencies = {
      tree_sitter = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tree-sitter."0.22.6" { inherit profileName; }).out;
    };
    buildDependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tree-sitter-rust."0.21.2" = overridableMkRustCrate (profileName: rec {
    name = "tree-sitter-rust";
    version = "0.21.2";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "277690f420bf90741dea984f3da038ace46c4fe6047cba57a66822226cde1c93"; };
    dependencies = {
      tree_sitter = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tree-sitter."0.22.6" { inherit profileName; }).out;
    };
    buildDependencies = {
  ...
  "git+https://github.com/maxxnino/tree-sitter-zig".tree-sitter-zig."0.0.1" = overridableMkRustCrate (profileName: rec {
    name = "tree-sitter-zig";
    version = "0.0.1";
    registry = "git+https://github.com/maxxnino/tree-sitter-zig";
    src = fetchCrateGit {
  ...
  "unknown".utils-tree-sitter."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      thiserror = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".thiserror."1.0.63" { inherit profileName; }).out;
      tree_sitter = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tree-sitter."0.22.6" { inherit profileName; }).out;
      tree_sitter_bash = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tree-sitter-bash."0.21.0" { inherit profileName; }).out;
      tree_sitter_c = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tree-sitter-c."0.21.4" { inherit profileName; }).out;
      tree_sitter_c_sharp = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tree-sitter-c-sharp."0.21.3" { inherit profileName; }).out;
      tree_sitter_cpp = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tree-sitter-cpp."0.22.3" { inherit profileName; }).out;
      tree_sitter_css = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tree-sitter-css."0.21.0" { inherit profileName; }).out;
      tree_sitter_elixir = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tree-sitter-elixir."0.2.0" { inherit profileName; }).out;
      tree_sitter_erlang = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tree-sitter-erlang."0.6.0" { inherit profileName; }).out;
      tree_sitter_go = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tree-sitter-go."0.21.0" { inherit profileName; }).out;
      tree_sitter_haskell = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tree-sitter-haskell."0.21.0" { inherit profileName; }).out;
      tree_sitter_html = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tree-sitter-html."0.20.3" { inherit profileName; }).out;
      tree_sitter_java = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tree-sitter-java."0.21.0" { inherit profileName; }).out;
      tree_sitter_javascript = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tree-sitter-javascript."0.21.4" { inherit profileName; }).out;
      tree_sitter_json = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tree-sitter-json."0.21.0" { inherit profileName; }).out;
      tree_sitter_lua = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tree-sitter-lua."0.1.0" { inherit profileName; }).out;
      tree_sitter_ocaml = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tree-sitter-ocaml."0.22.0" { inherit profileName; }).out;
      tree_sitter_python = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tree-sitter-python."0.21.0" { inherit profileName; }).out;
      tree_sitter_rust = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tree-sitter-rust."0.21.2" { inherit profileName; }).out;
    };
    buildDependencies = {
      cc = (buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".cc."1.0.106" { profileName = "__noProfile"; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".which."4.4.2" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal" then "either" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".either."1.13.0" { inherit profileName; }).out;
      ${ if (rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal") && (hostPlatform.isWindows || hostPlatform.isUnix || hostPlatform.parsed.kernel.name == "redox") then "home" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".home."0.5.9" { inherit profileName; }).out;
      ${ if (rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal") && hostPlatform.isWindows then "once_cell" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".once_cell."1.19.0" { inherit profileName; }).out;
      ${ if rootFeatures' ? "lsp-ai/cuda" || rootFeatures' ? "lsp-ai/llama_cpp" || rootFeatures' ? "lsp-ai/metal" then "rustix" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustix."0.38.34" { inherit profileName; }).out;
    };
  });
